...
namespace api.Utilities
{
    public class VendingMachineUtilities
    {
        public List<VendingMachine> GetAllVendingMachines()
        {
            ...
            while(rdr.Read())
            {
                AllVendingMachines.Add(new VendingMachine(){VendID = rdr.GetInt32(0), Address = rdr.GetString(1), ZipCode = rdr.GetInt32(2), Deleted = rdr.GetBoolean(3)});
            }
            con.Close();
        ...
        public void NewVendingMachine(VendingMachine myVendingMachine)
        {
            ...
            string stm = @"INSERT INTO VendingMachines (Address, ZipCode) VALUES(@Address, @ZipCode)";
